    ...
    return (
        <div>
            <Layout useBackdrop={true} usePadding={false}>
                ...
                <footer className="p-4 mt-6 bg-white sm:p-6 dark:bg-gray-800">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="/" className="flex items-center">
                                <img src="logo.png" className="mr-3 h-14" alt="Logo"/>
                                <span
                                    className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AI Ecom</span>
                            </a>
                        </div>
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                                                                                            className="hover:underline">AI Ecom™</a>. All Rights Reserved.
        </span>
